    ...
    return _temp = _class = /*#__PURE__*/function (_Component) {
      ...
      function BlockResizeableDecorator() {
        ...
        _this.mouseMove = function (evt) {
          ...
          var pane = ReactDOM__default['default'].findDOMNode(_assertThisInitialized(_this));
...
var createSetResizeData = function createSetResizeData(contentBlock, _ref) {
  ...
  return function (data) {
    ...
    if (entityKey) {
      ...
      setEditorState(draftJs.EditorState.forceSelection(editorState, editorState.getSelection()));
    }
  };
};
