import { Modifier, CharacterMetadata, ContentBlock, genKey, BlockMapBuilder, SelectionState, EditorState } from 'draft-js';
...
var handleDrop = (function (selection, dataTransfer, isInternal, _ref) {
  ...
  if (data[0] === DRAFTJS_BLOCK_KEY) {
    ...
    var newState = EditorState.push(editorState, contentStateAfterRemove, 'insert-fragment');
...
var createDecorator = (function (_ref) {
  ...
  return function (WrappedComponent) {
    var BlockDraggableDecorator = /*#__PURE__*/React.forwardRef(function (props, ref) {
