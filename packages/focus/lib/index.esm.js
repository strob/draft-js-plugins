import { ContentBlock, genKey, BlockMapBuilder, EditorState, SelectionState, Modifier } from 'draft-js';
...
function removeBlock(editorState, blockKey) {
  ...
  if (beforeBlock === undefined) {
    ...
    var _newState = EditorState.push(editorState, content, 'remove-range'); // force to new selection
  ...
  var newState = EditorState.push(editorState, content, 'remove-range'); // force to new selection
