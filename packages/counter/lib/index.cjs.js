...
var CharCounter = function CharCounter(_ref) {
  ...
  var getCharCount = function getCharCount(editorState) {
    var decodeUnicode = function decodeUnicode(str) {
      return punycode__default['default'].ucs2.decode(str);
  ...
  var getClassNames = function getClassNames(count) {
    var defaultStyle = clsx__default['default'](theme.counter, className);
    var overLimitStyle = clsx__default['default'](theme.counterOverLimit, className);
...
CharCounter.propTypes = {
  ...
  store: PropTypes__default['default'].any,
  limit: PropTypes__default['default'].any
};
...
CustomCounter.propTypes = {
  ...
  className: PropTypes__default['default'].any,
  limit: PropTypes__default['default'].number,
  countFunction: PropTypes__default['default'].func.isRequired
};
...
var index = (function (config) {
  ...
  var DecoratedCharCounter = function DecoratedCharCounter(props) {
    return /*#__PURE__*/React__default['default'].createElement(CharCounter, _extends({}, props, {
      theme: theme,
      store: store
    }));
  };
  ...
  var DecoratedWordCounter = function DecoratedWordCounter(props) {
    return /*#__PURE__*/React__default['default'].createElement(WordCounter, _extends({}, props, {
      theme: theme,
      store: store
    }));
  };
  ...
  var DecoratedLineCounter = function DecoratedLineCounter(props) {
    return /*#__PURE__*/React__default['default'].createElement(LineCounter, _extends({}, props, {
      theme: theme,
      store: store
    }));
  };
  ...
  var DecoratedCustomCounter = function DecoratedCustomCounter(props) {
    return /*#__PURE__*/React__default['default'].createElement(CustomCounter, _extends({}, props, {
      theme: theme,
      store: store
    }));
  };
