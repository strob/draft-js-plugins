...
import { AlignBlockDefaultButton, AlignBlockLeftButton, AlignBlockCenterButton, AlignBlockRightButton } from '@draft-js-plugins/buttons';
  ...
  return function (WrappedComponent) {
    ...
    return _temp = _class = /*#__PURE__*/function (_Component) {
      ...
      _proto.render = function render() {
        ...
        return /*#__PURE__*/React.createElement(WrappedComponent, _extends({}, elementProps, {
    ...
    }(Component), _class.displayName = "Alignment(" + getDisplayName(WrappedComponent) + ")", _class.WrappedComponent = WrappedComponent.WrappedComponent || WrappedComponent, _temp;
  };
});
...
function AlignmentTool(props) {
  ...
  var ref = useRef();
  var onVisibilityChanged = useCallback(function (visibleBlock) {
  ...
  var onAlignmentChange = useCallback(function (value) {
    if (value) {
      setAlignment(value);
    }
  }, []);
...
var createSetAlignment = function createSetAlignment(contentBlock, _ref) {
  ...
  return function (data) {
    ...
    if (entityKey) {
      ...
      setEditorState(EditorState.forceSelection(_editorState, _editorState.getSelection()));
    }
  };
};
...
var index = (function (config) {
  ...
  var DecoratedAlignmentTool = function DecoratedAlignmentTool() {
    return /*#__PURE__*/React.createElement(AlignmentTool, {
      store: store,
      theme: theme
    });
  };
