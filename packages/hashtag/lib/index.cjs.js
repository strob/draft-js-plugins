...
function Hashtag(props) {
  var _props$theme = props.theme,
      ...
      props.start;
      props.end;
      var otherProps = _objectWithoutPropertiesLoose(props, ["theme", "className", "decoratedText", "dir", "entityKey", "getEditorState", "offsetKey", "setEditorState", "contentState", "blockKey", "start", "end"]);

  var combinedClassName = clsx__default['default'](theme.hashtag, className);
...
var index = (function (config) {
  ...
  var _config = config,
      ...
      _config$hashtagCompon = _config.hashtagComponent,
      HashtagComponent = _config$hashtagCompon === void 0 ? Hashtag : _config$hashtagCompon;

  var DecoratedHashtag = function DecoratedHashtag(props) {
    return /*#__PURE__*/React__default['default'].createElement(HashtagComponent, _extends({}, props, {
      theme: theme
    }));
  };
