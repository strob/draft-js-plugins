...
var EmojiSuggestions = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var _this$props = this.props,
        ...
        restProps = _objectWithoutPropertiesLoose(_this$props, ["theme", "ariaProps", "callbacks", "onClose", "onOpen", "onSearchChange", "positionSuggestions", "shortNames", "store", "emojiImage"]);
...
function createEmojisFromStrategy() {
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(data__default['default']), _step; !(_step = _iterator()).done;) {
    ...
    var emoji = emojiToolkit.emojiList[shortName];
...
var Popover = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, groups[activeGroup].title), /*#__PURE__*/React__default['default'].createElement(Groups, {
      theme: theme,
      groups: groups,
      emojis: emojis,
...
var index = (function (config) {
  ...
  var suggestionsProps = {
    ...
    shortNames: immutable.List(keys__default['default'](emojiList.list)),
    emojiImage: emojiImage
  };
  var selectProps = {
    theme: theme,
